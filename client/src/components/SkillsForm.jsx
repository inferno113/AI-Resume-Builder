    ...
    return(
        <div className="space-y-4">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500">Add your relevant skills.</p>
            </div>
            ...
            {data.length>0 ? (
                <div className="flex flex-wrap gap-2">
                    ...
                    {data.map((skill, index)=>(
                        <span key={index} className="flex items-center gap-1 bg-gray-200 text-gray-800 px-3 py-1 rounded-full text-sm">
                            {skill}
                ...
                <div className="text-center py-6 text-gray-500">
                    <Sparkle className="w-10 h-10 text-gray-300 mx-auto mb-3"/>
