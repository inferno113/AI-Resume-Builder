import { BriefcaseBusiness, Globe, Mail, Phone, User, UserIcon } from "lucide-react";
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                ...
                <label htmlFor="user-image-upload">
                    ...
                    <input id="user-image-upload" type="file" accept="image/jpeg,image/png" className="hidden" onChange={(e)=>handleImageChange('image', e.target.files[0])} />
                    ...
                    return (
                        <div key={field.key} className="space-y-1 mt-5">
                           <label htmlFor="" className="flex items-center gap-2 text-sm font-medium text-gray-600">
                            ...
                            <input type={field.type} value={data[field.key] || ""} onChange={(e)=>handleImageChange(field.key,e.target.value)}  className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-non transition-colors text-sm" placeholder={`Enter your ${field.label.toLowerCase()}`} required={field.required}/>
