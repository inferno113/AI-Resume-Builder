...
const Navbar =()=>{
    ...
    //content from the videdo i have been learning from
        ...
        <div className='shadow bg-white'>
            ...
            <nav className="flex items-center justify-between max-w-7xl mx-auto px-4 py-3.5 text-slate-800 transition-all">
                ...
                <div className='flex items-center gap-4 text-sm'>
                    ...
                    <button onClick={logoutUser} className="bg-white hover:bg-green-500  border border-black-700 px-7 py-1.5 rounded-full active:scale-95 transition-all">
                        Logout
                    </button>
                </div>
    ...
    //navbar from tailwind css with user profile and dropdown menu
    // const navLinks = [
    //     { name: 'Home', path: '/' },
    //     { name: 'Your Resume', path: '/' },
    //     { name: 'Feedback', path: '/' },
    //     { name: 'About Us', path: '/' },
    // ];
    ...
    //                 <img src="/logo.svg" alt="logo" className="h-11 width-auto" />
    //             </a>
